...
namespace FitGoals.Controllers
{
    public class MeasurementsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MeasurementID,MeasurementName")] Measurement measurement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MeasurementID,MeasurementName")] Measurement measurement)
        {
            if (ModelState.IsValid)
            {
